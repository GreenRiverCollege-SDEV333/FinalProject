...
public class HashSet<KeyType> implements MathSet<KeyType> {
    ...
    VVV code manages the inside of the bucket of the hash table
            a linked list is inside each bucket
    SeparateChainingHashST depends on having SequentialSearchST (just make sure it doesn't have keys and values ???)
